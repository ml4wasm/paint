...
var worker=new Worker("worker.js");var c=document.getElementById("myCanvas");var ctx=c.getContext("2d");var mImgData=ctx.createImageData(300,300);(async()=>{await wasm_bindgen('./pkg/grok_bg.wasm')})();Array.prototype.extend=function(other_array){other_array.forEach(function(v){this.push(v)},this)}
